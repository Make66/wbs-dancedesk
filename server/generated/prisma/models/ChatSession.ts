...
export type ChatSessionWhereInput = {
  ...
  participantId?: Prisma.UuidFilter<"ChatSession"> | string
  tenantId?: Prisma.StringFilter<"ChatSession"> | string
  domain?: Prisma.StringNullableFilter<"ChatSession"> | string | null
  expiresAt?: Prisma.DateTimeFilter<"ChatSession"> | Date | string
...
export type ChatSessionScalarWhereWithAggregatesInput = {
  ...
  participantId?: Prisma.UuidWithAggregatesFilter<"ChatSession"> | string
  tenantId?: Prisma.StringWithAggregatesFilter<"ChatSession"> | string
  domain?: Prisma.StringNullableWithAggregatesFilter<"ChatSession"> | string | null
  expiresAt?: Prisma.DateTimeWithAggregatesFilter<"ChatSession"> | Date | string
...
export type ChatSessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"participantId" | "tenantId" | "domain" | "expiresAt" | "id" | "createdAt" | "updatedAt", ExtArgs["result"]["chatSession"]>
...
export interface ChatSessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const chatSessionWithParticipantIdOnly = await prisma.chatSession.findMany({ select: { participantId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ChatSessions and only return the `participantId`
   * const chatSessionWithParticipantIdOnly = await prisma.chatSession.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ChatSessions and only return the `participantId`
   * const chatSessionWithParticipantIdOnly = await prisma.chatSession.updateManyAndReturn({
   *   select: { participantId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ChatSessionFieldRefs {
  readonly participantId: Prisma.FieldRef<"ChatSession", 'String'>
  readonly tenantId: Prisma.FieldRef<"ChatSession", 'String'>
  readonly domain: Prisma.FieldRef<"ChatSession", 'String'>
  readonly expiresAt: Prisma.FieldRef<"ChatSession", 'DateTime'>
