...
export type ChatMessageWhereInput = {
  ...
  order?: Prisma.IntFilter<"ChatMessage"> | number
...
export type ChatMessageScalarWhereWithAggregatesInput = {
  ...
  order?: Prisma.IntWithAggregatesFilter<"ChatMessage"> | number
...
export type ChatMessageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"role" | "content" | "order" | "sessionId" | "id" | "createdAt", ExtArgs["result"]["chatMessage"]>
...
export interface ChatMessageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const chatMessageWithRoleOnly = await prisma.chatMessage.findMany({ select: { role: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ChatMessages and only return the `role`
   * const chatMessageWithRoleOnly = await prisma.chatMessage.createManyAndReturn({
   *   select: { role: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ChatMessages and only return the `role`
   * const chatMessageWithRoleOnly = await prisma.chatMessage.updateManyAndReturn({
   *   select: { role: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ChatMessageFieldRefs {
  ...
  readonly order: Prisma.FieldRef<"ChatMessage", 'Int'>
