...
export const RegistrationUpsertOneSchema: z.ZodType<Prisma.RegistrationUpsertArgs> = z.object({ select: RegistrationSelectObjectSchema.optional(),  where: RegistrationWhereUniqueInputObjectSchema, create: z.union([ RegistrationCreateInputObjectSchema, RegistrationUncheckedCreateInputObjectSchema ]), update: z.union([ RegistrationUpdateInputObjectSchema, RegistrationUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.RegistrationUpsertArgs>;

export const RegistrationUpsertOneZodSchema = z.object({ select: RegistrationSelectObjectSchema.optional(),  where: RegistrationWhereUniqueInputObjectSchema, create: z.union([ RegistrationCreateInputObjectSchema, RegistrationUncheckedCreateInputObjectSchema ]), update: z.union([ RegistrationUpdateInputObjectSchema, RegistrationUncheckedUpdateInputObjectSchema ]) }).strict();