...
export const InstructorFindManySelectSchema: z.ZodType<Prisma.InstructorSelect> = z.object({
...
export const InstructorFindManySelectZodSchema = z.object({
    name: z.boolean().optional(),
    imageUrl: z.boolean().optional(),
    active: z.boolean().optional(),
    courses: z.boolean().optional(),
...
export const InstructorFindManySchema: z.ZodType<Prisma.InstructorFindManyArgs> = z.object({ select: InstructorFindManySelectSchema.optional(), include: z.lazy(() => InstructorIncludeObjectSchema.optional()), orderBy: z.union([InstructorOrderByWithRelationInputObjectSchema, InstructorOrderByWithRelationInputObjectSchema.array()]).optional(), where: InstructorWhereInputObjectSchema.optional(), cursor: InstructorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InstructorScalarFieldEnumSchema, InstructorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InstructorFindManyArgs>;

export const InstructorFindManyZodSchema = z.object({ select: InstructorFindManySelectSchema.optional(), include: z.lazy(() => InstructorIncludeObjectSchema.optional()), orderBy: z.union([InstructorOrderByWithRelationInputObjectSchema, InstructorOrderByWithRelationInputObjectSchema.array()]).optional(), where: InstructorWhereInputObjectSchema.optional(), cursor: InstructorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InstructorScalarFieldEnumSchema, InstructorScalarFieldEnumSchema.array()]).optional() }).strict();