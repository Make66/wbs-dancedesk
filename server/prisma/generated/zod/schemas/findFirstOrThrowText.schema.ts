...
export const TextFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TextSelect> = z.object({
...
export const TextFindFirstOrThrowSelectZodSchema = z.object({
    name: z.boolean().optional(),
    type: z.boolean().optional(),
    text: z.boolean().optional(),
    courseTerms: z.boolean().optional(),
...
export const TextFindFirstOrThrowSchema: z.ZodType<Prisma.TextFindFirstOrThrowArgs> = z.object({ select: TextFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TextIncludeObjectSchema.optional()), orderBy: z.union([TextOrderByWithRelationInputObjectSchema, TextOrderByWithRelationInputObjectSchema.array()]).optional(), where: TextWhereInputObjectSchema.optional(), cursor: TextWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TextScalarFieldEnumSchema, TextScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TextFindFirstOrThrowArgs>;

export const TextFindFirstOrThrowZodSchema = z.object({ select: TextFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TextIncludeObjectSchema.optional()), orderBy: z.union([TextOrderByWithRelationInputObjectSchema, TextOrderByWithRelationInputObjectSchema.array()]).optional(), where: TextWhereInputObjectSchema.optional(), cursor: TextWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TextScalarFieldEnumSchema, TextScalarFieldEnumSchema.array()]).optional() }).strict();