...
export const CourseFindFirstSelectSchema: z.ZodType<Prisma.CourseSelect> = z.object({
...
export const CourseFindFirstSelectZodSchema = z.object({
    name: z.boolean().optional(),
    category: z.boolean().optional(),
    categoryId: z.boolean().optional(),
    seq: z.boolean().optional(),
