...
export const CourseFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CourseSelect> = z.object({
...
export const CourseFindFirstOrThrowSelectZodSchema = z.object({
    name: z.boolean().optional(),
    category: z.boolean().optional(),
    categoryId: z.boolean().optional(),
    seq: z.boolean().optional(),
