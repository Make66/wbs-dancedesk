...
import PaymentPicker1 from "./PaymentPicker1";
...
const CourseForm1 = ({ course, onSubmit }: CourseFormProps) => {
    ...
    <form onSubmit={handleSubmit(onFormSubmit)}>
      <div className="grid grid-cols-2 gap-16">
        <div className="flex flex-col gap-6 mt-3">
          <div>
            <Input className="w-full" label="Kursname" {...register("name")} />
          ...
          <PaymentPicker1 selected={selectedPaymentTypes} onChange={setSelectedPaymentTypes} />
